...
public class JMCh12Exercises
{
    ...
    {
        return new int[] { 1, 2, 4 }; // TODO fix this
    }
    ...
    {
        int sum = 0;
        for ( int x = 0; x < arrayOf3Ints().length; x++ )
        {
            sum = sum + arrayOf3Ints()[x];
        }
    ...
    public boolean[] prob2abcdTrueFalse()
    {
        ...
        // to question (a) - (d)
        return new boolean[] { false, true, true, false }; // TODO fix this!!
    }
    ...
    {
        char[] charList;
        charList = new char[] { 'r', 'r', 'r', 'p', 'p', 'p', 'p', 'p', 's',
            's', 's', 's', 's', 's', };

        return charList[(int)( Math.random() * charList.length )]; // TODO fix
                                                                   // this!!
    }
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        // TODO: replace empty string with answer
        String answer = mCount
            + " counts how many 0s there are in the beginning of v";
    ...
    public static int[] makePythagoreanTriple( int m, int n )
    {
        ...
        c = m * m + n * n;
        int[] tripleList;
        tripleList = new int[] { a, b, c };

        return tripleList; // TODO fix this!!
    }
    ...
    public static int computeScore( String word )
    {
        ...
        {
            index = alphabet.indexOf( word.charAt( x ) );
            scoreTotal += letterScores[index];
        }
        return scoreTotal; // TODO fix this!!
    }
    ...
    public boolean[] prob11abcdeTrueFalse()
    {
        // return a boolean array with answers corresponding
        // to question (a) - (e)
        return new boolean[] { true, true, false, false, true }; // TODO fix
                                                                 // this
    }
    ...
    {
        ArrayList<String> reversedArray = new ArrayList<String>( list.size() );

        for ( int i = list.size() - 1; i > -1; i-- )
        {
            reversedArray.add( list.get( i ) );
        }
        return reversedArray; // TODO fix this!!
    }
    ...
    public static void main( String[] args )
    {
        ...
        do
        {
            ...
            System.out
                .println( "   (C) 12-12 reverse( ArrayList<String> list )" );
            System.out.println(
                "   (D) 12-13 removeMin( ArrayList<Integer> list )" );
            System.out.println(
                "   (E) 12-14 filter(ArrayList<Object> list1, ArrayList<Object> list2)" );
            System.out.println( "   (F) 12-17 prob17FixBug()" );
            System.out.println(
                "   (G) 12-18 isMedian( double[] sample, double m )" );
            System.out.println( "   (H) 12-20 averageTopTwo( int[] scores )" );
            System.out.println(
                "   (I) 12-26 liesOnDiagonal( int[][] matrix, int i, int j )" );
            System.out.println( "   (J) 12-27 positiveMax( double[][] m )" );
            System.out.println(
                "   (K) 12-29 covers( double[][] m1, double[][] m2 )" );
            ...
            if ( response.length() > 0 )
            {
                ...
                switch ( response.charAt( 0 ) )
                {
                    ...
                    case '8':
                        int m = 1;
                        int n = 2;
                        System.out.println( "makePythagoreanTriple(" + m + ", "
                            + n + ") --> " + Arrays.toString(
                                exercise.makePythagoreanTriple( m, n ) ) );
                        break;
                    case '9':
                        int maxWedgeVal = 5;
                        System.out.println( "createWedge(" + maxWedgeVal
                            + ") --> " + Arrays.toString(
                                exercise.createWedge( maxWedgeVal ) ) );
                        break;
                    case 'A':
                    case 'a':
                    ...
                    case 'B':
                    case 'b':
                        boolean[] prob11abcdeAns = exercise
                            .prob11abcdeTrueFalse();
                    ...
                    case 'c':
                        ...
                        System.out.println(
                            "reverse( list ) = " + exercise.reverse( list ) );
                        break;
                    case 'D':
                    case 'd':
                        ...
                        System.out.println(
                            "after removeMin( intList ) --> " + intList );
                        break;
                    case 'E':
                    case 'e':
                        ...
                        System.out.println(
                            "after filter(list1, list2) --> " + list1 );
                        break;
                    case 'F':
                    case 'f':
                    ...
                    case 'g':
                        ...
                        System.out
                            .println( "isMedian(" + Arrays.toString( sample )
                                + ", " + ( median - 1 ) + ") = "
                    ...
                    case 'h':
                        ...
                        System.out.println(
                            "averageTopTwo(" + Arrays.toString( scores2 )
