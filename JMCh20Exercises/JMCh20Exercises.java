...
public class JMCh20Exercises<E>
{
    ...
    public int sizeRecur( ListNode<E> head )
    {
        ...
        return 1 + sizeRecur( head.getNext() );
    }
    ...
    {
        ListNode<E> add = new ListNode<E>( value, null );
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        while ( x != null )
        {
            ListNode<E> temp = new ListNode<E>( x.getValue(), tempHead );
            tempHead = temp;
            x = x.getNext();
        }
    ...
    {
        ListNode<String> node = head, prevNode = null;
        ...
        while ( node != null && s.compareTo( (String)node.getValue() ) > 0 )
        {
            prevNode = node;
            node = node.getNext();
        }
        ...
        ListNode<String> newNode = new ListNode<String>( s, node );
    ...
    public static void sort( ListNode<String> head )
    {
        ...
        while ( i != null )
        {
            ListNode<String> maxValueInHead = i;
            for ( ListNode<String> j = i; j != null; j = j.getNext() )
            {
                if ( maxValueInHead.getValue().compareTo( j.getValue() ) > 0 )
                {
                    maxValueInHead = j;
                }
            }
            swapWithString( maxValueInHead, i );
            i = i.getNext();
        }
    }


    private static void swapWithString(
        ListNode<String> node1,
        ListNode<String> node2 )
    {
        String temp = node1.getValue();
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        ...
        // int sizeOfHead = 0;
        ListNode2<Integer> node = head.getNext();
        ...
        // node = node.getNext();
        // }
        for ( ListNode2<Integer> i = head; node != null; node = node
            .getNext() )
        {
        ...
        else if ( max.getNext() == null )
        {
            max.getPrevious().setNext( null );
        }
        else
        {
    ...
    private static void swap(
        ListNode2<Double> node1,
        ListNode2<Double> node2 )
    {
    ...
    public static void main( String[] args )
    {
        ...
        do
        {
            ...
            System.out
                .println( "   (3) 20-3 removeFirst( ListNode<E> head )" );
            System.out.println( "   (4) 20-4a sizeFor( ListNode<E> head )" );
            System.out.println( "   (5) 20-4b sizeRecur( ListNode<E> head )" );
            System.out
                .println( "   (6) 20-5 add( ListNode<E> head, E value )" );
            System.out
                .println( "   (7) 20-6 reverseList( ListNode<E> head )" );
            System.out.println(
                "   (8) 20-7 concatenateStrings( ListNode<String> head )" );
            System.out.println( "   (9) 20-8 rotate( ListNode<E> head )" );
            System.out.println(
                "   (A) 20-9 insertInOrder( ListNode<String> head, String s )" );
            System.out
                .println( "   (B) 20-10 middleNode( ListNode<E> head )" );
            System.out.println(
                "   (C) 20-11 moveToBack( ListNode<String> head, String pattern )" );
            System.out.println( "   (D) 20-13 sort( ListNode<String> head )" );
            System.out.println(
                "   (E) 20-14 removeMax( ListNode2<Integer> head )" );
            System.out.println(
            ...
            if ( response.length() > 0 )
            {
                ...
                switch ( response.charAt( 0 ) )
                {
                    ...
                    case '2':
                        ...
                        break;
                    case '3':
                        ListNode<String> head3 = buildList(
                            new String[] { "a", "b", "c", "d" } );
                        System.out.println( strList( head3 ) );
                        System.out
                            .println( strList( ex.removeFirst( head3 ) ) );
                        break;
                    case '4':
                    ...
                    case '6':
                        ...
                        System.out
                            .println( strList( ex.add( head6, "zebra" ) ) );
                    ...
                    case '8':
                        ...
                        ListNode<String> concatHead = ex
                            .concatenateStrings( head8 );
                        System.out.println(
                            "Concatenate: " + strList( concatHead ) );
                    ...
                    case '9':
                        ...
                        System.out
                            .println( "Rotate: " + strList( rotateHead ) );
                    ...
                    case 'a':
                        ...
                        ListNode<String> insHead = ex.insertInOrder( headA,
                            "N" );
                        System.out.println(
                            "insert in order: " + strList( insHead ) );
                    ...
                    case 'b':
                        ...
                        System.out
                            .println( "Middle Node: " + strList( midNode ) );
                    ...
                    case 'E':
                    case 'e':
                        ListNode2<Integer> headE = buildList2(
                            new Integer[] { 1, 22, 3, 1234, 99 } );
                        System.out.println( "Original: " + strList2( headE ) );
                        ListNode2<Integer> maxHead = removeMax( headE );
                        System.out
                            .println( "removeMax: " + strList2( maxHead ) );
                        break;
                    case 'F':
                    case 'f':
                        ListNode2<Double> headF = buildList2(
                            new Double[] { 101.0, 22.2, 3.22, 1234.0, 99.9 } );
                        ...
                        System.out
                            .println( "quickSort: " + strList2( headF ) );
                        break;
                    default:
