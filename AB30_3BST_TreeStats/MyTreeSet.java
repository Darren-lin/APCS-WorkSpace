...
public class MyTreeSet<E>
{
    ...
    private int width( TreeNode<E> root )
    {
        if ( root != null )
        {
            return max( width( root.getLeft() ),
                max( width( root.getRight() ),
                    height( root.getLeft() ) + 1
    ...
    private void accumulate( TreeNode<Integer> root )
    {
        ...
        else
        {
            ...
            {
                rootVal += root.getLeft().getValue();
            }
            if ( root.getRight() != null )
            {
                rootVal += root.getRight().getValue();
            }
    ...
    //    while(min.getLeft() != null || max.getRight() != null )
    //    {
    //        if( min.getLeft() == null && max.getRight() != null)
    //        {
     //           max = max.getRight();
     //       }
     //       else  if(min.getLeft() != null && max.getRight() == null)
     //       {
     //           min = min.getLeft();
      //      }
       //     else if(min.getLeft() != null && max.getRight() != null)
       ...
       // }
        ...
        valueOfMin = min.getValue();
        while(max.getRight() != null)
        {
            max = max.getRight();
        }
        valueOfMax = max.getValue();
        return (valueOfMin + valueOfMax) / 2.0;
    }
